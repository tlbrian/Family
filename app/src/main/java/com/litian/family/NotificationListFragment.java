...
//			lastMessage.setText(user.hometown);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
	    ...
	    MyFirestore.getInstance().searchFriendRequestsToUser(UserProfile.get(), new MyFirestore.OnAccessDatabase<List<Notification>>() {
		    @Override
	...
	private void acceptFriendRequest(Notification notification) {
		MyFirestore.getInstance().searchUserByUid(notification.getFrom_uid(), new MyFirestore.OnAccessDatabase<User>() {
			...
			public void onComplete(User data) {
				if (data != null) {
					UserProfile.get().addFriend(data.getUid());
					MyFirestore.getInstance().updateFriendList(UserProfile.get(), data, new MyFirestore.OnAccessDatabase<User>() {
						@Override
						public void onComplete(User data) {
		...
		MyFirestore.getInstance().updateFriendRequest(notification.getFrom_uid(), UserProfile.get().getUid(), null);
	}
...
//		String tagName = "android:switcher:" + R.id.pager + ":" + 0; // Your pager name & tab no of Second Fragment
//
//		//Get SecondFragment object from FirstFragment
//		ChatListFragment f = (ChatListFragment)getActivity().findFragmentByTag(tagName);
//
